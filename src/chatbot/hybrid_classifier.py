"""
MLP (Multi-Layer Perceptron) model for intent classification.
"""
import numpy as np

from .models import hybrid_model, classes
...
def predict_intent_hybrid(sentence, vocabulary, error_threshold=0.10):
    """
    Predict intent class using HYBRID model.
    ...
    probabilities = hybrid_model.predict_proba(model_input)[0]
