...
from .mlp_classifier import predict_intent_mlp
...
def predict_class(
    ...
    """
    Predict intent class from sentence using specified algorithm.
    
    Args:
        sentence: User input text
        algorithm: "mlp" or "nb" model
    ...
    """
    if algorithm == "mlp":
        return predict_intent_mlp(sentence, words, error_threshold)
    elif algorithm == "nb":
